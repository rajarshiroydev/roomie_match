...
async def add_room(
    ...
    area: Annotated[
        str | None, Field(description="Area/neighborhood", default=None)
    ] = None,
    rent: Annotated[
        int | None, Field(description="Monthly rent in INR", default=None)
    ] = None,
    gender_pref: Annotated[
        str | None, Field(description='"Male"|"Female"|"Any"', default=None)
    ] = None,
    spots_available: Annotated[
        int | None, Field(description="Number of spots", default=None)
    ] = None,
    description: Annotated[
        str | None, Field(description="A short description", default=None)
    ] = None,
    pincode: Annotated[
        str | None, Field(description="6-digit pincode", default=None)
    ] = None,
    amenities: Annotated[
        List[str] | None, Field(description="List of amenities", default=None)
    ] = None,
) -> str:
    # Slot filling logic
    missing_fields = []
    ...
    if not spots_available:
        missing_fields.append("spots available")
    if not description:
        missing_fields.append("a description")
    if missing_fields:
    ...
    if gender_n not in {"Male", "Female", "Any"}:
        raise McpError(
            ErrorData(
                code=INVALID_PARAMS,
                message='gender_pref must be "Male", "Female", or "Any"',
            )
        )
...
async def delete_room(
    room_id: Annotated[
        str, Field(description="The public ID of the room, e.g., 'R015'.")
    ],
    management_key: Annotated[
        str, Field(description="The secret key provided when you created the listing.")
    ],
) -> str:
...
async def edit_room(
    ...
    rent: Annotated[
        int | None, Field(description="The new monthly rent.", default=None)
    ] = None,
    description: Annotated[
        str | None, Field(description="The new description.", default=None)
    ] = None,
    spots_available: Annotated[
        int | None, Field(description="The new number of spots.", default=None)
    ] = None,
    amenities: Annotated[
        List[str] | None, Field(description="The new list of amenities.", default=None)
    ] = None,
) -> str:
...
class RoomSearchInput(BaseModel):
    city: str | None = Field(
        default=None, description="City name to filter (e.g., Bengaluru)"
    )
    area: str | None = Field(
        default=None, description="Area/neighborhood to filter (e.g., Koramangala)"
    )
    ...
    gender_pref: str | None = Field(
        default=None, description='Preferred gender: "Male"|"Female"|"Any"'
    )
    amenities: List[str] | None = Field(
        default=None, description="List of required amenities, e.g., ['WiFi','AC']"
    )
...
async def room_finder(
    ...
    pincode: Annotated[
        str | None, Field(description="Pincode filter", default=None)
    ] = None,
    max_rent: Annotated[
        int | None, Field(description="Maximum rent (INR)", default=None)
    ] = None,
    gender_pref: Annotated[
        str | None,
        Field(description='Preferred gender: "Male"|"Female"|"Any"', default=None),
    ] = None,
    amenities: Annotated[
        List[str] | None, Field(description="Amenities required", default=None)
    ] = None,
    limit: Annotated[
        int, Field(description="Max results (1-50)", ge=1, le=50, default=10)
    ] = 10,
) -> str:
    ...
    req_amenities = [
        normalize_amenity(a) for a in (amenities or []) if a and normalize_amenity(a)
    ]
